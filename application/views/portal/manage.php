...
<div id="navigation">
    ...
    <div id="link-wrap">
        ...
        <div><img src="<?php echo $portal_img; ?>pie-icon.png"><a href="/codeigniter/index.php/portal/reports">Reports</a></div>
        <div id="active-nav"><img src="<?php echo $portal_img; ?>manage-icon.png"><a href="/codeigniter/index.php/portal/manage">Manage Campaigns</a></div>
    </div>
    <div id="nav-user">
